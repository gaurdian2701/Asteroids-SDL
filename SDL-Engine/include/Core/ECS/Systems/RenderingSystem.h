...
namespace Core::ECS::Systems
{
    ...
    private:
        inline glm::vec2 ConvertToScreenCoordinates(glm::vec2 someCartesianCoordinates);
    ...
    private:
        ...
        std::tuple<std::vector<std::uint32_t>&, std::vector<std::uint32_t>&> m_interestedSparseArrays =
            ECSManager::GetInstance().QuerySparseEntityArrays<
                Assets::Components::Transform, Assets::Components::Renderer2D>();
    };
}
